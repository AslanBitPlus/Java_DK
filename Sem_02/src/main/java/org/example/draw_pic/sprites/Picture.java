package org.example.draw_pic.sprites;
...
public class Picture extends Sprite {
    ...
    public Picture(int x, int y){
        ...
        halfWidth = 62;
        try {
            image = ImageIO.read(new File("C:/Users/Aslan/IdeaProjects/Java_DK/Sem_02/src/main/java/org/example/draw_pic/resource/picachu.png"));
        } catch (IOException e) {
